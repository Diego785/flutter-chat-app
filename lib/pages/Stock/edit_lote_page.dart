...
class EditLotePage extends StatefulWidget {
  final Lote lote;
  const EditLotePage({required this.lote, super.key});
...
class _EditLotePageState extends State<EditLotePage> {
  late TextEditingController _creationDateTimeController;
  late TextEditingController _expirationDateTimeController;
  late TextEditingController _deliveryDateTimeController;
  late TextEditingController _productSelectedTextController;
  late TextEditingController _cantidadTextController;

  String _idProductoSelected = "";
  String _nombreProductoSelected = "";
  ...
  void loadProductos() async {
    ...
    _creationDateTimeController.text == widget.lote.fechaCreacion.toString();

    setState(() {});
  }

  void _dataContent() {
    _creationDateTimeController =
        TextEditingController(text: widget.lote.fechaCreacion.toString());

    _expirationDateTimeController =
        TextEditingController(text: widget.lote.fechaVencimiento.toString());
    _deliveryDateTimeController =
        TextEditingController(text: widget.lote.fechaEntrega.toString());
    _productSelectedTextController =
        TextEditingController(text: widget.lote.producto.nombre);
    _idProductoSelected = widget.lote.producto.id;
    _currentQuantity = widget.lote.cantidad;
  }
    ...
    showDatePicker(
      ...
      setState(() {
        if (value != null) {
          ...
          _creationDateTime = widget.lote.fechaCreacion;
        }
